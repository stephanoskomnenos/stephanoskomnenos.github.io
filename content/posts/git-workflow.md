...
title = "Git Workflow"
date = 2022-05-20
lastmod = 2022-05-20T23:36:13+08:00
tags = ["git"]
draft = false
...
## Undoing Commits &amp; Changes {#undoing-commits-and-changes}
...
## Merge vs. Rebase {#merge-vs-dot-rebase}
...
{{< figure src="/ox-hugo/2022-05-20_22-51-28_screenshot.png" >}}

经过签名的 commit 在 github 上会显示 "Verified" 标签。

详见 Github 文档：

[Managing commit signature verification - GitHub Docs](https://docs.github.com/en/enterprise-server@3.5/authentication/managing-commit-signature-verification)